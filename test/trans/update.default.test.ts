...
(async () => {
    ...
    await mcTest({
        name    : "should update a record by Id and return success[transactional]:",
        testFunc: async () => {
            crudParams.tableName = groupCollUpdate
    ...
    await mcTest({
        name    : "should update records by query-params and return success for updating single record[transactional]:",
        testFunc: async () => {
            crudParams.tableName = groupCollUpdate;
    ...
    await mcTest({
        name    : "should return unique-error [paramsError, exists or saveError] for updating multiple-records by Ids[transactional]:",
        testFunc: async () => {
            crudParams.tableName = groupCollUpdate
            crudParams.actionParams = [GroupUpdateRecordById]
    ...
    await mcTest({
        name    : "should return error updating a non-unique/existing document[transactional]:",
        testFunc: async () => {
            crudParams.tableName = groupCollUpdate
            crudParams.actionParams = [GroupUpdateRecordByParam]
            crudParams.recordIds = [UpdateGroupById]
